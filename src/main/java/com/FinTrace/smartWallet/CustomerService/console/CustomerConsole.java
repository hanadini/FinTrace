...
public class CustomerConsole  extends BaseConsole{
    ...
    @Autowired
    public CustomerConsole(CustomerFacade customerFacade, ObjectMapper objectMapper) {
        super(objectMapper);
    ...
    private void addCustomer() {
        ...
        if ("REAL".equals(type)) {
            ...
            realCustomer.setEmail(scanner.nextLine());
            ...
            legalCustomer.setBusinessAddress(scanner.nextLine());
